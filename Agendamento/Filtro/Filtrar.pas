...
procedure TFrmFiltroAgendamento.BtnLimparClick(Sender: TObject);
begin
   EdtFuncionarioFiltro.Text := '';
   edtClienteFiltro.Text := '';
   nomeCliente := '';
   nomeFunc := '';
end;

procedure TFrmFiltroAgendamento.FormActivate(Sender: TObject);
begin
