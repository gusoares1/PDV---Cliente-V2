...
MySQL - 10.4.32-MariaDB : Database - pdv
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`pdv` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;

USE `pdv`;

/*Table structure for table `agendamento_pagamento` */

DROP TABLE IF EXISTS `agendamento_pagamento`;

CREATE TABLE `agendamento_pagamento` (
  `idAgendamento` int(11) NOT NULL,
  `tipo_pagamento` varchar(50) NOT NULL,
  `valor_pago` decimal(10,2) DEFAULT NULL,
  `parcemento` int(10) NOT NULL,
  `data_pagamento` datetime DEFAULT NULL,
  PRIMARY KEY (`idAgendamento`,`tipo_pagamento`),
  CONSTRAINT `fk_agendamento_pagamento` FOREIGN KEY (`idAgendamento`) REFERENCES `agendamentos` (`id`) ON DELETE CASCADE
...
CREATE TABLE `agendamento_servicos` (
  `idAgendamento` int(11) NOT NULL,
  `seqServico` int(11) NOT NULL,
  `nomeServico` varchar(100) DEFAULT NULL,
  `preco` decimal(10,2) DEFAULT NULL,
  `desconto` int(11) DEFAULT NULL,
  PRIMARY KEY (`idAgendamento`,`seqServico`),
  CONSTRAINT `fk_agendamento_servicos` FOREIGN KEY (`idAgendamento`) REFERENCES `agendamentos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `agendamento_servicos` */
...
CREATE TABLE `agendamentos` (
  ...
  `ConfirmacaoCliente` tinyint(4) DEFAULT NULL,
...
insert  into `config_whatsapp`(`id`,`api_url`,`client_token`) values 
(1,'https://api.z-api.io/instances/3E1726B1D31EE095FF260293E183E9A4/token/BBB272B2C01FCA3C071EB3D6/send-text','Fc4d9fd1501ed45488ee4acdd7a1a52c8S');
...
insert  into `servico`(`id`,`nome`,`preco`,`descricao`,`tempo_estimado`) values 
(5,'Instalar',50.00,'facil',NULL),
(11,'Limpeza 1 ',50.00,'basica',NULL),
(12,'servico 3',550.00,'completa',NULL);
...
CREATE TABLE `usuarios` (
  ...
  `cargo` varchar(25) NOT NULL,
  `id_funcionario` int(25) NOT NULL,
  PRIMARY KEY (`id`)
...
(11,'Igor','igao','1234','Operador de caixa',18),
(13,'Pedro','Pedro','123456','Operador de caixa',15);
